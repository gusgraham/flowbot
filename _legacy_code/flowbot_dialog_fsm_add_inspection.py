...
from ui_elements.ui_flowbot_dialog_fsm_inspection_base import Ui_Dialog


class flowbot_dialog_fsm_add_inspection(QtWidgets.QDialog, Ui_Dialog):

    def __init__(self, parent=None):
        """Constructor."""
        super(flowbot_dialog_fsm_add_inspection, self).__init__(parent)
        self.setupUi(self)
        ...
        if file_dialog.exec_():
            ...
            if selected_files:
                ...
                with open(pdf_file_path, 'rb') as file:
                    self.inspection_sheet = file.read()
                    self.txt_inspection_sheet.setText(pdf_file_path)
